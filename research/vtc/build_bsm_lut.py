...
CSV_PATH = os.path.join(BASE_DIR, "56데이터.csv")

# ==========================================
# [1] 공통 환경 파라미터 (Hard/Soft Constraints)
# ==========================================
BASE_CONFIG = {
    "MAX_N": 64.0,                    # N 정규화용 최대값 (513-Byte 기준)
...
if __name__ == "__main__":
    ...
    for mode_name, weights in MODES.items():
        ...
        lut_path = os.path.join(BASE_DIR, f"56LUT_{mode_name}.csv")
        pdf_path = os.path.join(BASE_DIR, f"56Heatmap_{mode_name}.pdf") # PNG -> PDF
